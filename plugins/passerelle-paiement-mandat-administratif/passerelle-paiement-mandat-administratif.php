...
function init_paiement_mandat_administratif_gateway() {
    ...
    class WC_Gateway_Paiement_Mandat_Administratif extends WC_Payment_Gateway {
        ...
        function send_email_to_client($order_id, $user_id,$client_email,) {
            ...
            error_log('email paiement mandat administratif envoyé à '.$civilite.' '.$nom.' '.$prenom);
            if ($invoice) {
            ...
            ">
                ...
                <h4 style="margin:20px 0;
                            ...
                            text-align:center;
                            font-size:18px;
                        ">Vous avez choisi de régler votre commande par mandat administratif</h4>
                
                    
                        Bonjour '.$civilite.' '.$nom.' '.$prenom.',
                        <br>
                    Merci pour votre commande Avast ! Vous avez choisi de régler votre commande par mandat administratif.
                    ...
                    <br>
                    <br>
                    P.S. Le paiement par mandat administratif est réservé exclusivement aux administrations françaises.
            ...
            $sent = wp_mail(
                $client_email,
                'Commande : Vous avez choisi de régler votre commande par mandat administratif',
                $message,
                $headers,
