	...
	<tr>
		...
		<td class="order-data">
			<table>
				...
				?>
				<?php if ( !empty( $client ) ) : ?>
					<tr class="payment-client-final-revendeur">
						<th>Client final :</th>
						<td><?php echo $client->display_name;  ?></td>
					</tr>
				<?php endif; ?>
				<?php if ( !empty( $billing_numero_siret ) ) : ?>
					<tr class="payment-numero-siret">
						<th>Numéro de SIRET :</th>
						<td><?php echo $billing_numero_siret;  ?></td>
					</tr>
				<?php endif; ?>
				<?php if ( !empty( $billing_societe ) ) : ?>
					<tr class="payment-societe">
						<th>Société :</th>
						<td><?php echo $billing_societe; ?></td>
					</tr>
				<?php endif; ?>
